...
RUN curl -SL https://github.com/edsondewes/docker-postgres-ecidade/releases/download/2.3.46-demo/e-cidade-demo-2.3.46.tar.gz | tar -xz -C /docker-entrypoint-initdb.d/